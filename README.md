...
Telegram --> colab_launcher.py
            ...
            ouroboros/               (agent core)
              ...
              llm.py                -- Gemini/OpenRouter router
...
|-----|----------|-----------------|
| `GEMINI_API_KEY` or `GEMINI_API_KEYS` | Yes | [aistudio.google.com/app/apikey](https://aistudio.google.com/app/apikey) -- One key or multiple keys (comma/newline separated) |
...
| `OPENROUTER_API_KEY` | No | [openrouter.ai/keys](https://openrouter.ai/keys) -- Optional for OpenRouter models and budget ground truth |
...
CFG = {
    ...
    # Models
    "OUROBOROS_MODEL": "gemini/gemini-1.5-flash",                # primary LLM (via Gemini)
    "OUROBOROS_MODEL_CODE": "anthropic/claude-sonnet-4.6",       # code editing (Claude Code CLI)
    "OUROBOROS_MODEL_LIGHT": "gemini/gemini-1.5-flash",          # consciousness + lightweight tasks
    ...
    "OUROBOROS_MODEL_FALLBACK_LIST": "gemini/gemini-1.5-flash,openai/gpt-4.1,anthropic/claude-sonnet-4.6",
    # Infrastructure
...
|----------|-------------|
| `GEMINI_API_KEY` or `GEMINI_API_KEYS` | Gemini API key(s) for primary LLM calls |
...
| Variable | Description |
|----------|-------------|
| `OPENROUTER_API_KEY` | Optional OpenRouter key for OpenRouter models and usage ground truth |
...
| `OUROBOROS_MODEL` | `gemini/gemini-1.5-flash` | Primary LLM model |
| `OUROBOROS_MODEL_CODE` | `anthropic/claude-sonnet-4.6` | Model for code editing tasks |
| `OUROBOROS_MODEL_LIGHT` | `gemini/gemini-1.5-flash` | Model for lightweight tasks (dedup, compaction) |
...
| `OUROBOROS_MODEL_FALLBACK_LIST` | `gemini/gemini-1.5-flash,openai/o3,anthropic/claude-sonnet-4.6` | Fallback model chain for empty responses |
